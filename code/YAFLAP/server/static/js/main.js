...
var getSemanticErrors = function () {
    return errorStr;
}

var getSemanticErrorsCount = function () {
    return errorCnt;
}
...
function ReadStatement(varexps) {
...
function getanalysisContextAncestor() {
    return analysisContextAncestor;
}

function getIntermediateCode(p) {
    intermediate_code = [];
    p.showSemanticGraph();
